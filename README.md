...
🔸 (Optional) Tweets (Twitter API integrated in code but commented)
...
Word cloud route via word_cloud.py
...
(Not included in backend code but supports any JS frontend)

🔥 API Endpoints (Accurate to Your Code)
...
🔄 Workflow (Exactly Matches Your Code)
